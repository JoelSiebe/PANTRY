...
cuisine_expander = st.expander("Preffered Cuisines")

with cuisine_expander:
...
#PNachfolgend wird überprüft, welche der Küchen angewählt wurden.
#zuerst wurde dies mit if.., nun wird eine for schlaufe versucht (daher der ursprüngliche teil in #)
