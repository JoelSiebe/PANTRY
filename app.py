...
api_key = "85225a1e57d84d85225a1e57d84d0bafc6d59d7dac51c50bafc6d59d7dac51c5"
...
def main():
    ...
    with st.form(key='recipe_form'):
        ...
        with col2:
            ...
            duration = st.selectbox("Enter duration in", ["Any", "0-15 minutes", "15-30 minutes", "30-60 minutes", "60+ minutes"])
